...
acicd_afdx_signal_int_charact::acicd_afdx_signal_int_charact(sql_database_manager *database_manager) : acicd_element (database_manager)
{
    DB_FIELDS= { { 55, "min" },
                 { 56, "max" },
               //  { 57, "unit" },
    ...
    DB_table_name="AFDX_SIGNAL_INT_DESC";
    test_field="rowid";
