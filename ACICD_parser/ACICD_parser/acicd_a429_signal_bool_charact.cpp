...
acicd_a429_signal_bool_charact::acicd_a429_signal_bool_charact(sql_database_manager *database_manager) : acicd_element (database_manager)
{
    DB_FIELDS= { { 46, "true_def" },
                 { 47, "false_def" },
                 { 48, "true_state" },
                 { 49, "false_state" },
                 { 50, "bool_logic" },
    ...
    DB_table_name="A429_SIGNAL_BOOL_DESC";
    test_field="rowid";
    ...
    create_table_query=QString("\
             CREATE TABLE IF NOT EXISTS [%1](\
                [true_def] VARCHAR( 45 ) CHECK (true_def != ''),\
                [false_def] VARCHAR( 45 ) CHECK (false_def != ''),\
                [true_state] INTEGER CHECK (true_state != ''),\
                [false_state] INTEGER CHECK (false_state != ''),\
