...
acicd_afdx_signal_string_charact::acicd_afdx_signal_string_charact(sql_database_manager *database_manager) : acicd_element (database_manager)
{
    DB_FIELDS= { { 46, "length" },
                 { 47, "format" }
               };

    DB_table_name="AFDX_SIGNAL_STRING_DESC";
    test_field="rowid";
