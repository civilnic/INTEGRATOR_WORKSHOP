...
acicd_afdx_message::acicd_afdx_message(sql_database_manager *database_manager) : acicd_element (database_manager)
{
    ...
    insert_query=QString("INSERT INTO %1 VALUES(:Name,:AFDX_APPLICATION,:AFDX_VL,:AFDX_TX_PORT,:AFDX_RX_PORT,:ACICD,:description,:ref_doc,:type,:AFDX_MESSAGE_TYPE,:Protocol_type,:Lenght,:Global_spare,:Transmission_rate)").arg(DB_table_name);
             ...
             CREATE TABLE IF NOT EXISTS [%1](\
                ...
                [Transmission_rate] INTEGER NULL,\
                 ...
                 CONSTRAINT [AFDX_APPLICATION]\
                        ...
                        REFERENCES [AFDX_APPLICATION] ( [rowid] ),\
                 CONSTRAINT [ACICD]\
                        FOREIGN KEY([ACICD])\
