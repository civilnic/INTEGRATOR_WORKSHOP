...
acicd_afdx_VL::acicd_afdx_VL(sql_database_manager *database_manager) : acicd_element (database_manager)
{
    ...
    insert_query=QString("INSERT INTO %1 VALUES(:VL_name,:VL_Identifier,:BAG,:MAX_frame_size,:Sub_VL_Number,:Sub_VL_Identifier,NULL,NULL,:IC_active,:Skew_max)").arg(DB_table_name);
